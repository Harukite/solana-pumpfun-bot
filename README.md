...
1. Download and extract the repository files: Use the command "git clone https://github.com/web3dev-rabby/solana-pumpfun-bot" or click the green "Code" button and select "Download ZIP".
